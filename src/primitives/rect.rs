...
impl Hit for Rect {
    ...
    fn bounding_box(&self) -> Option<Aabb>{
        ...
        match self.axes{
            RectAxes::XY => Some(Aabb::new(Point3::<f32>::new(self.corner(0),self.corner(2), self.k-0.0001), Point3::<f32>::new(self.corner(1), self.corner(3), self.k+0.0001))),
            RectAxes::XZ => Some(Aabb::new(Point3::<f32>::new(self.corner(0),self.k-0.0001, self.corner(2)) , Point3::<f32>::new(self.corner(1),self.k+0.0001, self.corner(3)))),
            RectAxes::YZ => Some(Aabb::new(Point3::<f32>::new(self.k-0.0001, self.corner(0),self.corner(2)), Point3::<f32>::new(self.k+0.0001, self.corner(1), self.corner(3))))
        }
    }
}
