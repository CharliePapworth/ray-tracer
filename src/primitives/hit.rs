...
impl<'a, I, H> Hit for &'a I where &'a I:IntoIterator<Item = &'a H>, I:?Sized, H: Hit + 'a {
    fn hit(&self, r: &Ray, t_min: f32, t_max: f32) -> Option<HitRecord> {
...
#[cfg(test)]
mod tests {
    use nalgebra::{Unit, Point3, Vector3};

    use super::*;
    use crate::{light::*, primitives::{Primitives, Triangle, Primitive}, material::{Material, Lambertian}};
